          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs" style={{ color: TEXT_SECONDARY }}>(Forthcoming, March 2026)</span>
              </div>
    ...
    const services = [
      {
        ...
        icon: "⚙️",
        desc: "We architect and deploy a content system that establishes you as the undisputed thought leader in your niche.",
        deliverable: "A portfolio of bylined articles in Tier-1 publications, a library of high-signal social content, and a narrative that attracts inbound leads.",
      },
      {
        title: "Narrative Architecture",
        icon: "🧭",
        desc: "A 2-week deep dive into your business to find the 'signal in the noise.' We diagnose your core value proposition and build a GTM narrative that your customers actually understand.",
        deliverable: "The 'Sovereign's Codex'—a master strategy document defining your mission, enemy, and story.",
      },
      {
        title: "Sovereign Advisory",
        icon: "👑",
        desc: "I become your fractional Head of Narrative Strategy. Direct access for critical decisions on product, marketing, and competitive warfare.",
        deliverable: "A second brain dedicated to your victory. (Limited to two clients per quarter).",
      },
    ];
    return (
      <Section id="services">
              ...
              {services.map((s) => (
                <div
                  ...
                  style={{ 
                    ...
                    backgroundColor: `rgba(234, 234, 234, 0.03)`,
                  }}
                >
                  <div className="text-3xl">{s.icon}</div>
                  <h3 className="mt-4 text-lg font-semibold" style={{ color: TEXT_PRIMARY }}>
                    {s.title}
                  </h3>
                  <p className="mt-2 text-sm leading-relaxed" style={{ color: TEXT_SECONDARY }}>
                    {s.desc}
                  </p>
                  <p className="mt-4 text-xs font-medium" style={{ color: TEXT_SECONDARY }}>
                    <span style={{ color: `rgba(234, 234, 234, 0.6)` }}>DELIVERABLE:</span> {s.deliverable}
                  </p>
                </div>
              ))}
            </div>
...
function PortfolioSection() {
    ...
    const items = [
      ...
      },
      {
        ...
        href: "https://logicforge.substack.com/p/the-death-of-the-sdr",
      },
      {
        ...
        cta: "Read The Report →",
        href: "https://logicforge.substack.com/p/the-digital-dollarization-of-africa",
      },
      {
              ...
              {items.map((item, index) => (
                ...
                >
                  <div className="flex-grow">
                    ...
                    <p className="mt-2 text-xs font-medium uppercase tracking-wider" style={{ color: TEXT_SECONDARY }}>
                      {item.subtitle}
                    </p>
                  ...
                  <a
                    ...
                    className={`mt-4 inline-flex items-center gap-1 text-sm font-medium ${
                      item.disabled ? "pointer-events-none" : "group"
                    }`}
                    style={{ color: ACCENT }}
                    target="_blank"
      ...
      <Section id="manifesto">
        <Container>
          ...
          >
            ...
            <p className="mt-6 text-pretty leading-relaxed sm:text-lg"
               style={{ color: TEXT_SECONDARY }}>
        ...
        <Container>
          ...
          >
            <div className="sm:col-span-4 flex justify-center">
              <div
                className="h-[200px] w-[200px] rounded-full border border-white/10 bg-white/5"
                aria-label="Professional headshot of Alexander Carter"
              />
            </div>
            <div className="sm:col-span-8">
              ...
              <p className="text-base font-medium mt-1" style={{ color: ACCENT }}>
                Technology Analyst & Narrative Strategist
              </p>
...
function ContactSection() {
    ...
    const budgetOptions = useMemo(
      () => [
        "Select...",
        "<$5k/mo (Advisory Only)",
        "$5k-10k/mo (Narrative Architecture)",
        "$10k+/mo (Authority Engine)",
      ],
      []
    );
              ...
              >
                <div className="grid gap-4">
                  <label className="grid gap-1.5">
                    <span className="text-sm font-medium" style={{ color: TEXT_SECONDARY }}>Your Name</span>
                    <input
                      required
                      className="h-11 rounded-md border border-white/10 bg-[#0a0a0a]/60 px-3 text-sm text-white outline-none transition focus:border-blue-500"
                    />
                  </label>
                  <label className="grid gap-1.5">
                    <span className="text-sm font-medium" style={{ color: TEXT_SECONDARY }}>Company URL</span>
                    <input
                      required
                      type="url"
                      className="h-11 rounded-md border border-white/10 bg-[#0a0a0a]/60 px-3 text-sm text-white outline-none transition focus:border-blue-500"
                  ...
                  <label className="grid gap-1.5">
                    ...
                    <textarea
                      required
                      rows={3}
                      className="rounded-md border border-white/10 bg-[#0a0a0a]/60 px-3 py-2 text-sm text-white outline-none transition focus:border-blue-500"
                      placeholder="In one sentence, what is the single biggest constraint holding back your growth?"
                    />
                  </label>
                  <label className="grid gap-1.5">
                    <span className="text-sm font-medium" style={{ color: TEXT_SECONDARY }}>Budget</span>
                    <select className="h-11 rounded-md border border-white/10 bg-[#0a0a0a]/60 px-3 text-sm text-white outline-none transition focus:border-blue-500">
                      {budgetOptions.map((b) => (
                ...
                <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <button
                    type="submit"
                    className="group inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-semibold text-white transition"
                  ...
                  <p className="text-xs text-white/50">
                    {status === "sent"
                      ? "Transmission queued. Acknowledged. I will respond if the mission is a fit."
          ...
          <div className="mt-24 border-t border-white/10 pt-8">
            <div className="flex flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left">
              <p className="text-xs text-white/40">
                © {new Date().getFullYear()} LogicForge.io
              </p>
              <div className="text-xs text-white/40">
                Built for signal. Deployed in dark mode.
              </div>
            </div>
          </div>
        </Container>
